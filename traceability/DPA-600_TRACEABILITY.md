...
| C600-015 | §18 rollback | DPA-INV-010, DPA-INV-014 | ADR-007, ADR-016 | DPA-300 §§11,13; DPA-500 §18 | Pre-Write, post-Write and incorrect-integration rollback cases | Keep protected ref unchanged or mark output non-accepted | Exact rollback ref, plan and guard identities | Governed repository rollback plus lifecycle recovery | DPA-700 owner; implementation NEEDS_MAIN_REPO_VALIDATION |
...
Discovery evidence at `vfi64/agentic-project-kit@6a9da7d363ae3f97f347b79a2679f6f848d8cdf3` recorded local reentrancy and workflow guards for the inspected scope. Those observations do not establish current behavior or DPA-600 conformance. Concrete mappings remain `NEEDS_MAIN_REPO_VALIDATION`.
